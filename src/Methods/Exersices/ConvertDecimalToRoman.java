...
public class ConvertDecimalToRoman {
     ...
     *
     * At first method validates if input string could be Roman number. After
     * method uses algorithm to convert Roman numeral to decimal.
     *
     * @param romanNumber
    ...
    /**
     * Utility method which is the part of algorithm that converts Roman numbers
     * to decimal.
     *
     * @param decimal
     * @param lastNumber
